...
def run_feedback_integrated():
    ...
    feedback_window.geometry('500x400+445+110')
...
#script_path_feedback = "C:\\Users\\PMLS\\AbuZarProjects\\error\\FeedBack.py"
...
bottom_panel = tk.Frame(root, bg='white', height=60)
